...
function insertProducts(callback)
{
    ...
    [
        new Product({
            ...
            imagePath: 'http://localhost:3000/uploads/7568644802_1_1_1.jpg',
        ...
        new Product({
            ...
            imagePath: 'http://localhost:3000/uploads/5644641800_2_5_1.jpg',
            title: 'Tank Top',
        ...
        new Product({
            ...
            imagePath: 'http://localhost:3000/uploads/7568469251_2_1_1.jpg',
            title: 'Basic Top',
        ...
        new Product({
            ...
            imagePath: 'http://localhost:3000/uploads/8197757093_2_2_1.jpg',
        ...
        new Product({
            ...
            imagePath: 'http://localhost:3000/uploads/1775300615_1_1_1.jpg',
        ...
        new Product({
            ...
            imagePath: 'http://localhost:3000/uploads/6186352407_2_1_1.jpg',
            title: 'Ripped Jeans',
        ...
        new Product({
            ...
            imagePath: 'http://localhost:3000/uploads/5575380406_1_1_1.jpg',
        ...
        new Product({
            ...
            imagePath: 'http://localhost:3000/uploads/3548350700_2_1_1.jpg',
...
function insertVariants(callback)
{
    ...
    [
        new Variant({
            ...
            imagePath: 'http://localhost:3000/uploads/7568644710_1_1_1.jpg',
            color: 'Beige',
            size: 'S,L',
            quantity: 5,
        }),
        new Variant({
            ...
            imagePath: 'http://localhost:3000/uploads/5644641735_2_5_1.jpg',
            color: 'Copper',
            size: 'S,L,XL',
            quantity: 12,
        }),
        new Variant({
            ...
            imagePath: 'http://localhost:3000/uploads/7568469605_2_1_1.jpg',
            color: 'Maroon',
            size: 'XS,M,L',
            quantity: 4,
        }),
        new Variant({
            productID: '5bedf448c14d7822b39d9d47',
            imagePath: 'http://localhost:3000/uploads/7568469822_2_1_1.jpg',
            color: 'Charcool',
            size: 'XS,L,XL',
            quantity: 5,
        }),
        new Variant({
            ...
            imagePath: 'http://localhost:3000/uploads/1775300806_2_1_1.jpg',
            color: 'Stone',
            size: 'S,XL',
            quantity: 35,
        }),
        new Variant({
            ...
            imagePath: 'http://localhost:3000/uploads/5575380407_1_1_1.jpg',
            color: 'Dark Blue',
            size: 'M,XL',
            quantity: 5,
        })
